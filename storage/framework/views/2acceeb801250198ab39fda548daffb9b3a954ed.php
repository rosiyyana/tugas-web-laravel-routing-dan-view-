...
<html lang="en">
  ...
  <!-- <a class="navbar-brand" href="#">Navbar</a> -->
    ...
    <div class="row ">
        <div class="sidebar col-md-3">
            <div class="portopolio text-center " style=" height : 486px ; background : #050505 ; margin-top : -57px">
                ...
                <img src="<?php echo e(('image/portopolio.JPG')); ?>" width="190px" style="margin-top : 138px">
    ...
    <div class="row ">   
        <img src="<?php echo e(('image/bg2.JPG')); ?>" width="1032px" style="margin-top:-186px" >
    </div>
  ...
  <br>
      <img class="rounded-circle"src="<?php echo e(('image/ide.png')); ?>" width="230" style=" margin-left : 100px; margin-top:-16px" >
  </div>
  ...
  <div class="col-md-6 text-justify " style="margin-top : -4px; margin-left:-3px">
      <p>Beberapa dokumentasi aplikasi yang sudah saya pelajari disekolah bisa dibilang sebagai tugas sekolah seperti membuat Ajax-Noloading, Autocomplete, Menampilkan data dari DB menggunakan PHP Ajax, Telebot, dan masih banyak lain nya.</p>
          <img class="rounded-circle col-md-3"src="<?php echo e(('image/logorpl.jpg')); ?>" width="210" style=" margin-left : 250px; margin-top:3px" >      
          <img class="rounded-circle col-md-3"src="<?php echo e(('image/logotb.jpg')); ?>" width="210" style=" margin-left : 397px; margin-top:-130px" >      
  <br>
  </div>
  </div>
  </section>
  ...
  <div class="card-deck">
  <div class="card">
    <img src="<?php echo e(('image/bot2.jpg')); ?>" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card">
    <img src="<?php echo e(('image/autocom.png')); ?>" class="card-img-top" alt="...">
    <div class="card-body">
      ...
      <p class="card-text"><small class="text-muted">Diposting 2 Menit Lalu</small></p>
    <img src="<?php echo e(('image/iventory.png')); ?>" class="card-img-top" alt="...">
  ...
  <div class="card">
    <img src="<?php echo e(('image/ajaxno.png')); ?>" class="card-img-top" alt="...">
    <div class="card-body">
      ...
      <p class="card-text"><small class="text-muted">Diposting 2 Menit Lalu</small></p>
      <img src="<?php echo e(('image/tamp_db.png')); ?>" class="card-img-top" alt="...">
...
</html><?php /**PATH C:\xampp\htdocs\LaravelTugas\resources\views/portofolio.blade.php ENDPATH**/ ?>